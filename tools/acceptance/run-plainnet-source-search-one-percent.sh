...
OUTPUT_ROOT=${ZCP_PLAINNET_SEARCH_ROOT:-${ZCP_ACCEPTANCE_ROOT:-$PROJECT_ROOT/runs/acceptance/plainnet-source-aligned-one-percent/$FLOPS_TARGET}}
...
payload = {
    **existing,
    ...
    "one_percent_search_completed": sys.argv[2] == "completed",
    "pid": os.getppid(),
