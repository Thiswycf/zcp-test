...
def train_model(
    ...
    *,
    ...
    for epoch in range(start_epoch, config.epochs):
        ...
        payload = {"epoch": epoch, "best_accuracy": best_accuracy, "model": model.state_dict(), "optimizer": optimizer.state_dict(), "scheduler": scheduler.state_dict(), "scaler": scaler.state_dict(), "rng": rng_state(), "config": config.__dict__}
