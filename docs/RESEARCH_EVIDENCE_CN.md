...
| [VKDNW](https://openaccess.thecvf.com/content/CVPR2025/html/Tybl_Training-free_Neural_Architecture_Search_through_Variance_of_Knowledge_of_Deep_CVPR_2025_paper.html) / [代码 `d2ff276`](https://github.com/ondratybl/VKDNW/tree/d2ff276d37d8ba2e9f8c04beb71499d0bd346146) | 参数 Fisher 谱分位数熵、随机/真实输入、FIM 维度、nDCG 与规模正交性消融 | NB201、MobileNetV2 直接；旧项目 `portable-v1` 结果无效 |
